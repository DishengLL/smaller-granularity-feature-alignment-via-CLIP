...
6. log: <....>/output/log/biomed_all_task_balance_S1_des_diago_prompt_trainable_vision_${time}.log\n\
7. using AP—PA—data"
...
--AP-PA-view >> "./log/biomed_all_task_balance_S1_des_diago_prompt_trainable_vision_${time}.log"
